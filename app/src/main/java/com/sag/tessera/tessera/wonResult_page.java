...
public class wonResult_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_won_result_page);
    ...
    public void nextLevel(View view) {
        startActivity(new Intent(getApplicationContext(),level2_splash.class)) ;
    }
